...
Third-party packages can self-register via the `apartment_tracker.plugins`
entry-point group.
"""
...
_BUILTIN_MODULES = (
    "apartment_tracker.sensors.mock",
    "apartment_tracker.sensors.camera",
    "apartment_tracker.sensors.ble",
    "apartment_tracker.sensors.tomography",
    "apartment_tracker.sensors.network",
    "apartment_tracker.detectors.aruco",
    "apartment_tracker.detectors.onnx",
    "apartment_tracker.training.trainers",
)
...
def load_plugins() -> None:
    ...
    for mod in _BUILTIN_MODULES:
        import_module(mod)
    for ep in entry_points(group="apartment_tracker.plugins"):
        ep.load()
